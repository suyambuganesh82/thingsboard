...
//            "AND ((:actionTypes) IS NULL OR a.actionType in (:actionTypes)) " +
            "AND (:textSearch IS NULL OR ilike(a.entityType, CONCAT('%', CAST(:textSearch AS string), '%')) = true " +
            "OR ilike(a.entityName, CONCAT('%', CAST(:textSearch AS string), '%')) = true " +
            "OR ilike(a.userName, CONCAT('%', CAST(:textSearch AS string), '%')) = true " +
            "OR ilike(a.actionType, CONCAT('%', CAST(:textSearch AS string), '%')) = true " +
            "OR ilike(a.actionStatus, CONCAT('%', CAST(:textSearch AS string), '%')) = true)"
    )
    ...
    @Query("SELECT a FROM AuditLogEntity a WHERE " +
            ...
            "AND ((:#{#actionTypes == null} = true) OR a.actionType IN (:actionTypes)) " + //HHH-15968
//            "AND ((:actionTypes) IS NULL OR a.actionType in (:actionTypes)) " +
            "AND (:textSearch IS NULL OR ilike(a.entityName, CONCAT('%', CAST(:textSearch AS string), '%')) = true " +
            "OR ilike(a.userName, CONCAT('%', CAST(:textSearch AS string), '%')) = true " +
            "OR ilike(a.actionType, CONCAT('%', CAST(:textSearch AS string), '%')) = true " +
            "OR ilike(a.actionStatus, CONCAT('%', CAST(:textSearch AS string), '%')) = true)"
    )
